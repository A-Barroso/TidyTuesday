...
ggdraw() +
  ...
  draw_label("Mean IMDb Rating: 8.2", x= 0.145, y = 0.271, colour = "white", size = 10) +
  draw_label("Mean IMDb Rating: 8.45", x= 0.38, y = 0.271, colour = "white", size = 10) +
  draw_label("Mean IMDb Rating: 8.3", x= 0.62, y = 0.271, colour = "white", size = 10) +
  draw_label("Mean IMDb Rating: 8.5", x= 0.855, y = 0.271, colour = "white", size = 10)
